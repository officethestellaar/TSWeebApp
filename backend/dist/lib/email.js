...
exports.sendNewActivityEmail = exports.sendResetPasswordEmail = void 0;
...
const sendResetPasswordEmail = async (email, tempPassword) => {
...
const sendNewActivityEmail = async (emails, activityName, activityDesc, startTime) => {
